...
//        rollNo = getIntent().getStringExtra("rollNo");
        ...
        Query dbRef = database.getReference("attendance").orderByChild("teacherNo").equalTo(courseName);
    ...
    public void setPieChart(ArrayList<CourseAttendance> attendanceList) {
        ...
        for (CourseAttendance temp : attendanceList) {
            if (temp.getPresentStudents().contains(courseName)) { // If student was present.
                ++totalPresent;
            } else if (temp.getAbsentStudents().contains(courseName)) { // If absent.
                ++totalAbsent;
    ...
    public void generatePDF(View view) {
        ...
        try {
            ...
            // Creating Chunk
            Chunk titleChunk = new Chunk("(" + courseName + ") " + courseName +" Attendance Report", font);
