    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = firebaseAuth -> {
            ...
            if (mAuth.getCurrentUser() != null) {
                Intent loginIntent = new Intent(AdminLogin.this, TeacherDashboard.class);
        ...
        mReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AdminLogin.this, ResetPasswordActivity.class));
            }
        });
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    assert user != null;
                    if (user.equals("principal@gmail.com")){

                        Toast.makeText(AdminLogin.this, "Welcome!", Toast.LENGTH_SHORT).show();

                        // Forward to next activity.
                        Intent intent = new Intent(AdminLogin.this, Principal.class);
                        // Attach the user data.
                        startActivity(intent);
                        finish();
                    }
                    else {
                        Toast.makeText(AdminLogin.this, "Your Not the Principal !!", Toast.LENGTH_SHORT).show();
                    }
